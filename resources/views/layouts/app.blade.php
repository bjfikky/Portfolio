...
<head>
    <title>Benjamin Orimoloye - Personal Portfolio</title>
    <meta charset="UTF-8">
...
<footer>
    <div class="container text-center">
        <div class="social"> <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i>  </a> <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i>  </a> <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i>  </a> <a href="#"><i class="fa fa-github" aria-hidden="true"></i>  </a> <a href="#"><i class="fa fa-dribbble" aria-hidden="true"></i>  </a> </div>
...
<!-- BACK TO TOP --><a href="#home" class="backtop"><i class="fa fa-chevron-up" aria-hidden="true"></i> </a>
<!-- SIDEBAR MENU -->
    ...
    <div class="scroll-out">
        ...
        <div class="col-md-12 sidebar-content">
            ...
            <div class="col-md-12 widget-twitter top_45">
                ...
                <div class="tweet"></div> <a href="https://twitter.com/envato" target="_blank" class="twitter-account">@envato</a> </div>
            <!-- Latest Posts -->
